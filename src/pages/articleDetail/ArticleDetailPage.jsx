      ...
      <section className="container mx-auto max-w-5xl flex flex-col px-5 py-5 lg:flex-row lg:gap-x-5 lg:items-start">
        <article className="flex-1">
          ...
          <div className="mt-4 text-dark-soft">
            <p className="leading-7">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi, ex dolorum. Hic, porro illo. Quam, laudantium inventore? Sequi ullam laboriosam velit, dolores non, perspiciatis voluptatem nobis, quo totam ipsum dolore?</p>
          </div>
